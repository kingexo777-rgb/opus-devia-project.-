...
export const GOVERNANCE = {
  ...
  MODELS: {
    ...
    DEEPSEEK_VISION: {
      ...
      intendedBckend: "DeepSeek Vision",
      roles: ["image_uplad"] as FatureRole[],
      isUserFacing: true,
    },
    DEEPGRAM_STT: {
      ...
      intendedBckend: "Deepgram Nova-3 (STT)",
      roles: ["voice_inpt"] as FatureRole[],
      scope: "mentor_sessions_only",
      audioPlicy: "discard_after_transcription",
      isUserFacing: true,
    },
    DEEPGRAM_TTS: {
      ...
      intendedBckend: "Deepgram Aura-2-Asteria (TTS)",
      roles: ["voice_outpt"] as FatureRole[],
